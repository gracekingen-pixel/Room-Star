  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-hero text-primary-foreground hover:shadow-float hover:scale-105 transition-spring font-semibold",
        architectural: "bg-architectural text-primary-foreground hover:bg-architectural/90 shadow-elegant",
        gold: "bg-gold text-accent-foreground hover:bg-gold/90 shadow-glow font-medium",
        space: "bg-space text-primary-foreground hover:bg-space/90 shadow-elegant",
      },
      size: {
